...
#[ApiResource(
    operations: [
        ...
        new GetCollection(
            uriTemplate: '/tfpnbs/stats',
            name: 'get_tfpnb_stats',
            provider: \App\State\TaxRegionStatsProvider::class,
            openapi: new \ApiPlatform\OpenApi\Model\Operation(
                summary: 'Statistiques globales (taux et montants) pour la TFPNB',
...
class Tfpnb
{
    ...
    #[ORM\ManyToOne(targetEntity: Departement::class, inversedBy: 'tfpnbs')]
